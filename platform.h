...
static inline char *safe_strncpy(char *out, char *in, int maxl) { strncpy(out,in,maxl); out[maxl-1]=0; return out; }
...
// socklen_t is properly defined on modern POSIX systems
// Legacy workaround removed - was causing type mismatch on Linux
